...
class wp_bootstrap_navwalker extends Walker_Nav_Menu {
    ...
    if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
      ...
      */
      ...
      if ( ! empty( $icon ) )
        ...
        $item_output .= '<a'. $attributes .'><span class="rmText">'; 
      ...
      if ( $item->post_parent == 0 ) {
        //$item_output .= "<li class='rmItem rmSeparator'><span class='rmText'></span></li>";
      }
  ...
  public function display_element( $element, &$children_elements, $max_depth, $depth, $args, &$output ) {
        ...
        if( $element->menu_order > 1 && $element->menu_item_parent == 0 ){
          $output .= "<li class='rmItem rmSeparator'><span class='rmText'></span></li>";  
        }
